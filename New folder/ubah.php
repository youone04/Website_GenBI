...
<body>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<ul>
			...
			<li>
				<label for="texts">judul berita : </label>
				<textarea name="texts" size = "40" autofocus autocomplete="off" cols="30" rows="7" id="texts" value="<?php echo $mhs["texts"]; ?>"  required></textarea>
			</li>
			<br>
